          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <SortableHeader column="school" label="School" sortBy={sortBy} sortDirection={sortDirection} onSort={handleSort} />
                <SortableHeader column="district" label="District" sortBy={sortBy} sortDirection={sortDirection} onSort={handleSort} />
                <SortableHeader column="type" label="Type" sortBy={sortBy} sortDirection={sortDirection} onSort={handleSort} />
