...
def upgrade() -> None:
    ...
    sa.Column('nces_id', sa.Integer(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.Enum('JEWISH', 'PRIVATE', 'PUBLIC', name='school_type'), nullable=False, unique=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('level', sa.Enum('ELEMENTARY', 'HIGH', 'MIDDLE', 'K8', 'K12', 'PRE', name='school_level'), nullable=True),
    sa.Column('district_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['district_id'], ['school_districts.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('school_to_school_types',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('school_id', sa.Integer(), nullable=False),
    sa.Column('type_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], ),
    sa.ForeignKeyConstraint(['type_id'], ['school_types.id'], ),
