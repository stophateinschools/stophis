...
def upgrade() -> None:
    ...
    op.drop_constraint("uq_school_types_name", "school_types", type_="unique")
    ...
    op.drop_constraint("uq_schools_nces_id", "schools", type_="unique")
...
def downgrade() -> None:
    ...
    op.create_unique_constraint("uq_schools_nces_id", "schools", ["nces_id"])
    ...
    op.create_unique_constraint("uq_school_types_name", "school_types", ["name"])
    op.add_column(
        "school_districts",
